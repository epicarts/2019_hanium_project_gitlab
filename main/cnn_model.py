...
params = {
    ...
    'mode': 'ft', # 훈련 모드 (fe: feature extraction, ft: finetuning)
...
def predict(img):
    ...
    print(os.getcwd())
    os.listdir('dataset\\train')
    
    
    img = load_img("dataset\\train\\ㄴ\\1570386447.3944645.jpg", target_size=(250,250))
    x = img_to_array(img)  # (3, 150, 150) 크기의 NumPy 배열
